...
public class FibonacciNim {
    ...
    private static int playerAReset = 1;
    private static int playerBReset = 1;
    ...
    static String reset(char currentPlayer, int chosenHeap) {
        ...
        if ((currentPlayer == '1' && playerAReset != EMPTY) || (currentPlayer == '2' && playerBReset != EMPTY)) {
            switch (chosenHeap) {
                ...
                case -3:
                    ...
                    break;
                default:
                    System.out.println("Uncommon logical error");
            }
