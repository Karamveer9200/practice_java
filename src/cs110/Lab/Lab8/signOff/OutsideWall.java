...
public class OutsideWall {
    ...
    private static double areaOfWalls;
    ...
    void areaOfWalls(double length, double height, double width, double areaOfWindow) {

        double lengthSide = (length * height) * lengthWalls;
        double widthSide = (width * height) * widthWalls;

        areaOfWalls = lengthSide + widthSide - areaOfWindow;
    }

    double heatLossWalls() {
        return areaOfWalls * uValueWalls * TEMP_DIFFERENCE;
    }
